...
1. Open the Google Colab notebook: [Link](https://colab.research.google.com/drive/1YY0txWSx25dd5qJcnf_5VATwHvXM0AOB?usp=drive_link)
...
10. **Choose the Script to Run**:
   - You can choose to run either `2-1.py` or `3-5.py`:
     - `Modal_2-1.py`: Suitable for most systems.
     - `Modal_3-5.py`: Requires a high-end GPU and takes nearly 50 times longer to run.
